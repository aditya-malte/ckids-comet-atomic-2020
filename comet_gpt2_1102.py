...
def main():
    ...
    train_dataset = pd.read_csv(os.environ.get('TRAIN_DATA_PATH', "./data/wiki_train.tsv"), encoding='latin-1', sep="\t", names = ['head_event', 'relation', 'tail_event'])
    if DEBUG:
    ...
    val_dataset = pd.read_csv(os.environ.get('DEV_DATA_PATH', "./data/wiki_dev.tsv"), encoding='latin-1', sep="\t", names = ['head_event', 'relation', 'tail_event'])
    if DEBUG:
    ...
    test_dataset = pd.read_csv(os.environ.get('TEST_DATA_PATH', "./data/wiki_test.tsv"), encoding='latin-1', sep="\t", names = ['head_event', 'relation', 'tail_event'])
    if DEBUG:
    ...
    val_dataset_mini = pd.read_csv(os.environ.get('DEV_DATA_PATH', "./data/wiki_dev.tsv"), encoding='latin-1', sep="\t", names = ['head_event', 'relation', 'tail_event'])
    if DEBUG:
...
#             pred_dataset = pd.read_csv(config.PRED_FILE, encoding='latin-1', sep="\t")
            pred_dataset = pd.read_csv('./data/wiki_input.tsv', encoding='latin-1', sep="\t", names = ['head_event', 'relation','tail_event'])
