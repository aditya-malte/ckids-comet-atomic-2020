...
def relation_mapping(words,relation):
	if(words[1]=="atlocation"):
		relation = relation.replace(" atlocation ", " is located at ")
	if(words[1]=="capableof"):
		relation = relation.replace(" capableof ", " is capable of ")
	if(words[1]=="createdby"):
		relation = relation.replace(" createdby ", " is creatd by ")
	if(words[1]=="isa"):
		relation = relation.replace(" isa ", " is a ")
	if(words[1]=="hassubevent"):
		relation = relation.replace(" hassubevent ", " requires ")
	if(words[1]=="partof"):
		relation = relation.replace(" partof ", " is part of ")
	if(words[1]=="hascontext"):
		relation = relation.replace(" hascontext ", " has the context ")
	if(words[1]=="hasproperty"):
		relation = relation.replace(" hasproperty ", " has the property ")
	if(words[1]=="madeof"):
		relation = relation.replace(" madeof ", " is made of ")
	if(words[1]=="notcapableof"):
		relation = relation.replace(" notcapableof ", " is not capable of ")
	if(words[1]=="notdesires"):
		relation = relation.replace(" notdesires ", " does not desire ")
	if(words[1]=="receivesaction"):
		relation = relation.replace(" receivesaction ", " receives action ")
	if(words[1]=="relatedto"):
		relation = relation.replace(" relatedto ", " is related to ")
	if(words[1]=="usedfor"):
		relation = relation.replace(" usedfor ", " is used for ")
	if(words[1]=="formof"):
		relation = relation.replace(" formof ", " is a form of ")
	if(words[1]=="hasa"):
		relation = relation.replace(" hasa ", " has a ")
	if(words[1]=="hasfirstsubevent"):
		relation = relation.replace(" hasfirstsubevent ", " starts with ")
	if(words[1]=="haslastsubevent"):
		relation = relation.replace(" haslastsubevent ", " ends with ")
	if(words[1]=="hasprerequisite"):
		relation = relation.replace(" hasprerequisite ", " requires ")
	if(words[1]=="motivatedbygoal"):
		relation = relation.replace(" motivatedbygoal ", " is motivated by ")
	if(words[1]=="obstructedby"):
		relation = relation.replace(" obstructedby ", " is obstructed by ")
	if(words[1]=="distinctfrom"):
		relation = relation.replace(" distinctfrom ", " is distinct from ")
	if(words[1]=="derivedfrom"):
		relation = relation.replace(" derivedfrom ", " is derived from ")
	if(words[1]=="symbolof"):
		relation = relation.replace(" symbolof ", " is a symbol of ")
	if(words[1]=="definedas"):
		relation = relation.replace(" definedas ", " is defined as ")
	if(words[1]=="mannerof"):
		relation = relation.replace(" mannerof ", " is manner of ")
	if(words[1]=="locatednear"):
		relation = relation.replace(" locatednear ", " is located near to ")
	if(words[1]=="similarto"):
		relation = relation.replace(" similarto ", " is similar to ")
	if(words[1]=="etymologicallyrelatedto"):
		relation = relation.replace(" etymologicallyrelatedto ", " is etymologically related to ")
	if(words[1]=="etymologicallyderivedfrom"):
		relation = relation.replace(" etymologicallyderivedfrom ", " is etymologically derived from ")
	if(words[1]=="causesdesire"):
		relation = relation.replace(" causesdesire ", " causes the desire to ")
	if(words[1]=="instanceof"):
		relation = relation.replace(" instanceof ", " is a ")
	if(words[1]=="entails"):
		relation = relation.replace(" entails ", " requires ")
	if(words[1]=="notdesires"):
		relation = relation.replace(" notdesires ", " not desires ")
	if(words[1]=="nothasproperty"):
		relation = relation.replace(" nothasproperty ", " does not have the property of ")
