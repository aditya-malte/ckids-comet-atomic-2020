...
INFILE_PATH = '/nas/home/linglan/ckids-comet-atomic-2020/data/'
INFILE_NAME = 'wikidata_bias_input.txt'
ENTIMENT_PATH = '/nas/home/linglan/ckids-comet-atomic-2020/Analysis/Sentiment/'
...
def sentiment_analyzer(key_words,all_concepts_long):
  ...
  for i in range(len(key_words)):
    ...
    outfile = open(ENTIMENT_PATH + "masked_sentiment_output/" + looking_concept,"w")
    ...
    for line_con in all_concepts_long: 
      ...
      if(looking_concept in words):
        ...
        mapped_concept = words[0] + " " + words[1] + " " + words[2]
...
if __name__ == "__main__":
  all_concepts_long =[]
  infile = open(INFILE_PATH + INFILE_NAME,"r")
